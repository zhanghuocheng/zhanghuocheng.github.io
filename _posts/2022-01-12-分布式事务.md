...
```
1 本地事务 特性 原子性(UNDO日志即备份日志) 持久性(REDO 日志) 一致性 隔离性 

2 分布式事务
XA (阶段提交)
	1 先准备 投票 提交， 缺点 1 单点故障问题(在提交之前挂了) 2 阻塞问题 使用场景 1 要求强一致性，对事务执行效率不敏感，代码入侵少
TCC
		分为三个独立的事务阶段 try confirm cancle 
		缺点 代码入侵高 开发成本高，需要解决幂等问题  优点 解决二阶段提交阻塞问题
		
可靠消息服务
	优缺点 优点 相对简单  缺点 有延迟 服务之间有依赖关系
AT
	1 解决阻塞问题 2 二阶段代码由框架生成，开发成本低
	缺点 跟tcc相比，需要动态生成反向sql 性能没有tcc好
saga模式
	特点 使用于长事务 时间驱动

	优点：解决阻塞问题 时间驱动  补偿服务易实现
	缺点 不保证隔离性 
...
![image-20200304201018438](../images/image-20200304201018438.png)
...
![image-20200304202639509](../images/image-20200304202639509.png)
...
![image-20200304204442839](../images/image-20200304204442839.png)
...
![image-20200304205842784](../images/image-20200304205842784.png) 
...
![image-20200304210120471](../images/image-20200304210120471.png) 
...
![image-20200304210414309](../images/image-20200304210414309.png) 

接下来，用户的读操作就会得到 v1。这就叫一致性。

![image-20200304210506575](../images/image-20200304210506575.png) 

问题是，用户有可能向 G2 发起读操作，由于 G2 的值没有发生变化，因此返回的是 v0。G1 和 G2 读操作的结果不一致，这就不满足一致性了。

![image-20200304210521364](../images/image-20200304210521364.png)

为了让 G2 也能变为 v1，就要在 G1 写操作的时候，让 G1 向 G2 发送一条消息，要求 G2 也改成 v1。

![image-20200304210540168](../images/image-20200304210540168.png) 

这样的话，用户向 G2 发起读操作，也能得到 v1。

![image-20200304210557117](../images/image-20200304210557117.png) 
...
![image-20200305141029973](../images/image-20200305141029973.png) 
...
![image-20200305141318326](../images/image-20200305141318326.png) 
...
- 单点故障问题
  ...
  ![image-20200305142812815](../images/image-20200305142812815.png) 
...
![image-20200305155521612](../images/image-20200305155521612.png) 
...
![image-20200305155830732](../images/image-20200305155830732.png)
...
![image-20200305181454125](../images/image-20200305181454125.png)
...
![image-20200305183431211](../images/image-20200305183431211.png) 
...
![image-20200305200131083](../images/image-20200305200131083.png)



一次消息发送的时序图：

![image-20200305205430863](../images/image-20200305205430863.png)
...
![image-20200305212340203](../images/image-20200305212340203.png)
...
![image-20200305213652558](../images/image-20200305213652558.png)
...
![image-20200305214649845](../images/image-20200305214649845.png)
...
![image-20200305225811888](../images/image-20200305225811888.png)
...
![Saga 模式](../images/1561965208439-606129fe-6761-4177-8887-1fda9306f104.png) 
...
![Seata](../images/1561960344792-8810110b-1eda-4417-944e-7051ca52f90d.png)
...
Seata 会有 4 种分布式事务解决方案，分别是 AT 模式、TCC 模式、Saga 模式和 XA 模式。![image-20200305230513415](../images/image-20200305230513415.png) 
...
![image-20200306164728739](../images/image-20200306164728739.png)
...
![image-20200306170419354](../images/image-20200306170419354.png) 

找到项目所在目录，选中并打开：

![image-20200306170520985](../images/image-20200306170520985.png) 

项目结构如下：

![image-20200306171827203](../images/image-20200306171827203.png) 
...
![image-20200306173439268](../images/image-20200306173439268.png) 

库存：

![image-20200306173511332](../images/image-20200306173511332.png) 
...
![image-20200306173343839](../images/image-20200306173343839.png) 

查看数据库数据：

余额：

![image-20200306173602942](../images/image-20200306173602942.png) 

库存：

![image-20200306173629491](../images/image-20200306173629491.png) 

订单：

![image-20200306173700813](../images/image-20200306173700813.png) 
...
![image-20200306173916953](../images/image-20200306173916953.png)

看下用户余额：

![image-20200306224048175](../images/image-20200306224048175.png) 

因为扣款失败，因此这里没有扣减

来看下库存数据：

![image-20200306174001901](../images/image-20200306174001901.png) 
...
![image-20200306174740064](../images/image-20200306174740064.png) 



然后解压即可，其目录结构如下：

![image-20200306174818712](../images/image-20200306174818712.png) 
...
![image-20200306201749660](../images/image-20200306201749660.png) 
...
![image-20200306223043452](../images/image-20200306223043452.png)
